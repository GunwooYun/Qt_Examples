...
QT_MOC_LITERAL(1, 13, 11), // "widgetClick"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12) // "processClick"

    },
    "CustomWidget\0widgetClick\0\0processClick"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomWidget::widgetClick)) {
                *result = 0;
                return;
            }
        }
